...
public class Parser {
    ...
    private void buildTestQueries() {
        ...
        queue.add(select(new String[]{"student"}, new String[]{"*"}, null, null, null));
        queue.add(select(new String[]{"student"}, new String[]{"name", "gpa"}, "id", "=", "1"));
        queue.add(select(new String[]{"course"},  new String[]{"*"}, null, null, null));
        queue.add(select(new String[]{"student", "course"}, new String[]{"*"}, null, null, null));
        queue.add(select(new String[]{"student", "course"}, new String[]{"*"}, "id", ">", "credits"));
